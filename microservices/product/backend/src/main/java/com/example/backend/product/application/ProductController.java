...
public class ProductController {
    ...
    @Operation(
            ...
            description = "Crea un nuevo producto con base en la información proporcionada",
            requestBody = @io.swagger.v3.oas.annotations.parameters.RequestBody(
                    ...
                    content = @io.swagger.v3.oas.annotations.media.Content(
                            examples = @ExampleObject(
                                    ...
                                    summary = "Producto válido",
                                    value = "{\"name\": \"Computer\", \"description\": \"A powerful computer\", \"price\": 1200.99, \"stock\": 50, \"categoryId\": \"66ecf8e319382626f90783e8\"}"
                            )
                    )
            )
    )
    ...
    @Operation(
            ...
            requestBody = @io.swagger.v3.oas.annotations.parameters.RequestBody(
                    description = "Cuerpo de la solicitud para actualizar un producto existente",
                    required = true,
                    content = @io.swagger.v3.oas.annotations.media.Content(
                            examples = @ExampleObject(
                                    name = "Ejemplo de actualización de producto",
                                    summary = "Producto válido para actualizar",
                                    value = "{\"name\": \"Updated Computer\", \"description\": \"An updated description for a powerful computer\", \"price\": 1300.99, \"stock\": 100, \"categoryId\": \"66ecf8e319382626f90783e8\"}"
                            )
                    )
            )
    )
    ...
    public ResponseEntity<ProductResponseDto> update(
            @Parameter(description = "ID del producto en formato hexString", example = "66ecb5d53e2cf02bef160395")
